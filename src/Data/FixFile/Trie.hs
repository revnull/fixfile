...
lookupTrieT :: Binary v => BS.ByteString -> Transaction (Trie v) s (Maybe v)
...
insertTrieT :: Binary v => BS.ByteString -> v -> Transaction (Trie v) (WT s) ()
...
deleteTrieT :: Binary v => BS.ByteString -> Transaction (Trie v) (WT s) ()
...
iterateTrieT :: Binary v => BS.ByteString ->
    Transaction (Trie v) s [(BS.ByteString, v)]
